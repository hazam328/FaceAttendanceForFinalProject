...
pak = timezone('Asia/Karachi')
date = str(datetime.now(pak))[:10] + "@" + str(datetime.now())[11:13] + "hrs"
...
conn = MySQLdb.connect(host="localhost",user="root",password="Pashtoon@328",db="login_info")
